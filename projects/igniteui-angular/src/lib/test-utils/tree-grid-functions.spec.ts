...
import { IgxTreeGridComponent, IgxRowComponent, IgxGridBaseComponent, IgxGridCellComponent, IgxDataBindable } from '../grids/tree-grid';
...
export class TreeGridFunctions {
    ...
    */
     ...
     */
    public static checkRowIsGrayedOut(row: IgxRowComponent<IgxGridBaseComponent & IgxDataBindable>): boolean {
     ...
     */
    public static checkRowIsNotGrayedOut(row: IgxRowComponent<IgxGridBaseComponent & IgxDataBindable>): boolean {
        return !row.nativeElement.classList.contains('igx-grid__tr--filtered');
    }
